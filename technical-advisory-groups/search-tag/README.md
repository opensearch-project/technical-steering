...
## Mission Statement
The OpenSearch Search Technical Advisory Group (TAG) guides technical direction and decision-making across all aspects of search - including core text search, vector search, semantic search, hybrid retrieval, relevance tuning and performance.

[Charter](./charter.md)

### Membership

We follow the membership guidelines proposed in [TAGs README](../README.md) to add / remove / amend / retire members for Search TAG.

| Member                 | GitHub ID | Affiliation            |
|------------------------| --------- |------------------------|
| Saurabh Singh          | [@getsaurabh02](https://github.com/getsaurabh02) | Amazon                 |
| Pallavi Priyadarshini  | [@Pallavi-AWS](https://github.com/Pallavi-AWS) | Amazon                 |
...
| Martin Gaievski        | [@mch2](https://github.com/mch2) | Amazon                 |
