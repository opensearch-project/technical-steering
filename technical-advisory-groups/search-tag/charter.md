# OpenSearch Search Technical Advisory Group (SEATAG) Governance Charter
...
This TAG ensures OpenSearch remains leader in the evolving search landscape by:
...
4. **Evaluation and Quality**: Enable users to navigate precision/recall and relevance/ranking trade-offs. Define hooks to measure overall effectiveness of search solutions. Provide tools that make the trade-offs between search performance and search quality clear.
